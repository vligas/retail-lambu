...
import { FooterComponent } from '@retail/shared/components/footer/footer.component';
import { CustomizerComponent } from '@retail/shared/components/customizer/customizer.component';
