...
export class NavigationService {
    ...
    defaultMenu: IMenuItem[] = [
        ...
        {
            name: 'Espia',
            description: 'Modulo de espionaje empresarial',
            type: 'dropDown',
            icon: 'i-Geek',
            sub: [
                { icon:'i-Bar-Chart', name:'Maestro de competidores',  state: '/spy/competitor', type: 'link'},
                { icon:'i-Bar-Chart', name:'Detalle de competidores',  state: '/spy/detail-competitor', type: 'extLink'},
            ]
        }
